...
class StudentRegister extends Migration {
    ...
    public function up() {
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_marital_status', function(Blueprint $table) {
        ...
        $position = 1;
        DB::table('_z_marital_status')->insert([
            [
                'name' => 'Undefined',
                'description' => '',
                'position' => $position++,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_family_relationship', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
        ...
        $position = 1;
        DB::table('_z_family_relationship')->insert([
            [
                'name' => 'Undefined',
                'position' => $position++,
                'created' => $unixTimeStamp,
...
|--------------------------------------------------------------------------
*/
        Schema::create('_z_single_category', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
            $table->integer('position')->unsigned();
            $table->integer('created')->unsigned();
        ...
        $position = 1;
        DB::table('_z_single_category')->insert([
            [
                'name' => 'Religion',
                'position' => $position++,
                'created' => $unixTimeStamp,
        ...
        Schema::create('_z_single_data', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_single_data', function(Blueprint $table) {
            $table->foreign('single_category_id')->references('id')->on('_z_single_category');
        });
        $position = 1;
        DB::table('_z_single_data')->insert([
            [
        ...
        DB::table('_z_single_data')->insert($dataArray);
        /*
|--------------------------------------------------------------------------
| Country
|--------------------------------------------------------------------------
*/
        Schema::create('_z_country', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_country_province', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_country_province', function(Blueprint $table) {
            $table->foreign('country_id')->references('id')->on('_z_country');
        });
        $position = 1;
        DB::table('_z_country_province')->insert([
            [
                'country_id' => 1,
                'name' => 'Unknown',
                'position' => $position++,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_country_city', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_country_city', function(Blueprint $table) {
            $table->foreign('province_id')->references('id')->on('_z_country_province');
        });
        $position = 1;
        DB::table('_z_country_city')->insert([
            [
                'province_id' => 1,
                'name' => 'Unknown',
                'position' => $position++,
...
|--------------------------------------------------------------------------
*/
        Schema::create('_z_country_region', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_country_region', function(Blueprint $table) {
            $table->foreign('city_id')->references('id')->on('_z_country_city');
        });
        $position = 1;
        DB::table('_z_country_region')->insert([
            [
                'city_id' => 1,
                'name' => 'Unknown',
                'position' => $position++,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_country_subregion', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_country_subregion', function(Blueprint $table) {
            $table->foreign('region_id')->references('id')->on('_z_country_region');
        });
        $position = 1;
        DB::table('_z_country_subregion')->insert([
            [
                'region_id' => 1,
                'name' => 'Unknown',
                'position' => $position++,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::create('_z_address_type', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
            $table->string('description')->default('');
            $table->integer('position')->unsigned();
        ...
        $position = 1;
        DB::table('_z_address_type')->insert([
            [
                'name' => 'Residential',
                'position' => $position++,
                'created' => $unixTimeStamp,
...
|--------------------------------------------------------------------------
*/
        Schema::create('_z_address', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_address', function(Blueprint $table) {
            $table->foreign('country_id')->references('id')->on('_z_country');
        });
        DB::table('_z_address')->insert([
            [
                'line_1' => '',
                'created' => $unixTimeStamp,
                'register_by' => 1,
...
|--------------------------------------------------------------------------
*/
        Schema::create('_z_qualification', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_qualification', function(Blueprint $table) {
        ...
        DB::table('_z_qualification')->insert([
            [
                'created' => $unixTimeStamp,
                'register_by' => 1,
                'modified' => $unixTimeStamp,
...
|--------------------------------------------------------------------------
*/
        Schema::create('_z_work_detail', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('_z_work_detail', function(Blueprint $table) {
        ...
        DB::table('_z_work_detail')->insert([
            [
                'created' => $unixTimeStamp,
                'register_by' => 1,
                'modified' => $unixTimeStamp,
...
|--------------------------------------------------------------------------
*/
        Schema::create('student_family_id', function(Blueprint $table) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::table('student_family_id', function(Blueprint $table) {
            $table->foreign('address_type_id')->references('id')->on('_z_address_type');
            $table->foreign('address_id')->references('id')->on('_z_address');
        });
        DB::table('student_family_id')->insert([
            [
                'family_code' => '180001',
                'created' => $unixTimeStamp,
                'register_by' => 1,
...
*/
        ...
        Schema::table('student_family', function(Blueprint $table) {
        ...
        DB::table('student_family')->insert([
            [
                'name' => 'Atif Naseem',
                'relationship_id' => 2,
                'marital_status_id' => 2,
...
*/
        ...
        DB::table('student_register')->insert([
            [
                'reg_id' => '180001',
                'name' => 'S Atif',
...
*/
        ...
        Schema::table('student_emergency_contact', function(Blueprint $table) {
            $table->foreign('family_id')->references('id')->on('student_family_id');
            $table->foreign('relationship_id')->references('id')->on('_z_family_relationship');
            $table->foreign('address_type_id')->references('id')->on('_z_address_type');
            $table->foreign('address_id')->references('id')->on('_z_address');
        });
        DB::table('student_emergency_contact')->insert([
            [
                'name' => 'Atif Naseem',
                'family_id' => 1,
                'relationship_id' => 2,
...
*/
    ...
    public function down() {
        Schema::drop('_z_marital_status');
        Schema::drop('_z_family_relationship');
        Schema::drop('_z_single_category');
        Schema::drop('_z_single_data');
        Schema::drop('_z_address_type');
        Schema::drop('_z_address');
        Schema::drop('_z_qualification');
        Schema::drop('_z_work_detail');
        Schema::drop('student_academic_record');
        Schema::drop('student_family_id');
        Schema::drop('student_family');
        Schema::drop('student_register');
        Schema::drop('student_emergency_contact');
    }
}
